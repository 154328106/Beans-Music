...
enum ChangelogStore {
    ...
    static let logs: [VersionLog] = [
        VersionLog(
            ...
            title: "播放器与账号体验集中修复",
            features: [
                "精简账号与播放来源，保留稳定的网易云与 QQ 音乐体验",
                "自定义底部布局新增循环按钮、上一首、下一首、播放列表与指示线的独立调节",
                "播放器底栏恢复旧式紧凑悬浮布局，中间播放暂停按钮保持新版 morph 动效",
                "歌词偏移统一作用于全屏歌词与 mini player，并支持 LRC 自带 offset 标签",
            ],
            fixes: [
                "移除不稳定的账号入口，避免登录状态误判和空列表反复加载",
                "清理相关后台请求，减少启动时无效网络访问与日志噪音",
                "圆形封面旋转默认关闭，手动开启时降低刷新频率并移除额外离屏渲染",
                "搜索页与本地歌单添加页仅展示当前支持的平台入口",
            ]
        ),
        ...
        VersionLog(
            ...
            features: [
                ...
                "聚合网易云 / QQ 音乐：扫码登录即可同步歌单、收藏与 VIP 标识",
...
struct UsageGuideSheet: View {
    ...
    private let sections: [(title: String, icon: String, lines: [String])] = [
        (
            ...
            [
                "Beans Music 是一款聚合网易云音乐与 QQ 音乐资源的第三方音乐播放器客户端，旨在为您提供跨平台的音乐发现、搜索与播放体验。本应用仅供个人学习研究使用，禁止用于商业及非法用途。"
            ]
        ),
        (
            "多平台切换",
        ...
        (
            ...
            [
                "「我的」页面支持网易云、QQ 音乐账号登录（扫码 / 网页授权）。登录后自动同步各平台歌单、收藏与 VIP 标识，享受完整播放权益。"
            ]
        ),
        (
            "播放体验",
